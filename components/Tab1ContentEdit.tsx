...
const Tab1ContentEdit = ({
                             ...
                             idCheckList,
                             itemsTabContent,
                             isFirstTab = true, // По умолчанию true, так как изначально на первом табе
                             isLastTab = false,
                         }: Tab1ContentEditType) => {
            ...
            <Footer>
                <View style={styles.footerContainer}>
                    <TextButton
                        ...
                        enabled={selectedValue > 0 || !isFirstTab} // Активна, если есть предыдущий параметр или не первый таб
                    ...
                    <TextButton
                        ...
                        onPress={handleNext}
                        enabled={selectedValue < items.length - 1 || !isLastTab} // Активна, если есть следующий параметр или не последний таб
